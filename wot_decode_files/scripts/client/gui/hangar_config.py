...
class HangarConfig(object):
    __slots__ = [
     ...
     'camStartAngles', 'camStartAnglesPlatoon', 'camStartTargetPos', 
     'camStartDist', 
     'camDistConstr', 'camMinDistVehicleHullLengthK', 'camPitchConstr', 
     'camYawConstr', 
     'camSens', 'camDistSens', 'camPivotPos', 
     'camFluency', 'emblemsAlphaDamaged', 'emblemsAlphaUndamaged', 
     'shadowLightDir', 
     'shadowModelName', 'shadowForwardYOffset', 'shadowDeferredYOffset', 
     'shadowDefaultTextureName', 
     'shadowEmptyTextureName', 'camCapsuleScale', 'camCapsuleGunScale', 
     'camIdlePitchConstr', 
     'camIdleDistConstr', 'camIdleYawPeriod', 'camIdlePitchPeriod', 
     'camIdleDistPeriod', 
     'camIdleEasingInTime', 'camParallaxDistance', 'camParallaxAngles', 
