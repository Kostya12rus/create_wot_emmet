...
class TOOLTIPS_CONSTANTS(object):
    ...
    COMMON_SET = [EFFICIENCY_PARAM, IGR_INFO, CONTACT, SORTIE_DIVISION, MAP, MAP_SMALL, CLAN_COMMON_INFO, 
     ...
     ACTION_XP, QUESTS_VEHICLE_BONUSES, ENVIRONMENT, MISSIONS_TOKEN, RESERVE_MODULE, 
     ...
     BATTLE_PASS_VEHICLE_POINTS, TECHTREE_DISCOUNT_INFO, TECHTREE_NATION_DISCOUNT, 
     ...
     WOT_PLUS, ADDITIONAL_REWARDS, BRCOIN_INFO_FULL_SCREEN, EQUIP_COIN_INFO_FULL_SCREEN, 
     OLD_RESERVE_MODULE]
    ...
    PERSONAL_MISSION_SET = [PERSONAL_QUESTS_PREVIEW, PERSONAL_MISSIONS_TANKWOMAN, PERSONAL_MISSIONS_TANKMODULE, 
     ...
     OPERATIONS_CHAIN_DETAILS, OPERATION_POSTPONED]
    ...
    TANKMAN_SET = [TANKMAN, TANKMAN_NEW_SKILL, TANKMAN_NOT_RECRUITED, BATTLE_ROYALE_TANKMAN, 
     CREW_PERK_GF]
    ...
    ROYALE_LOBBY_SET = [BATTLE_ROYALE_VEHICLE, BATTLE_ROYALE_MODULES_HANGAR, BATTLE_ROYALE_BATTLE_PROGRESSION, 
     BATTLE_ROYALE_EQUIPMENT, BATTLE_ROYALE_PERF_SIMPLE, BATTLE_ROYALE_PERF_ADVANCED, 
     BATTLE_ROYALE_SELECTOR_INFO, BATTLE_ROYALE_WIDGET_INFO, BATTLE_ROYALE_COMPLETED_QUESTS_INFO, 
     BATTLE_ROYALE_SELECTOR_CALENDAR_INFO, BATTLE_ROYALE_PROXY_CURRENCY]
    MAPBOX_LOBBY_SET = [MAPBOX_SELECTOR_INFO, MAPBOX_PROGRESSION_PREVIEW, SELECTABLE_CREWBOOK, RANDOM_CREWBOOK, 
     MAPBOX_CALENDAR]
    ACCOUNT_COMPLETION_SET = [ACCOUNT_COMPLETION, DEMO_ACCOUNT_RENAME_PROCESSING]
    FUN_RANDOM_LOBBY_SET = [FUN_RANDOM_CALENDAR_DAY, FUN_RANDOM_MODE_SELECTOR_CALENDAR_DAY, FUN_RANDOM_CAROUSEL_VEHICLE, 
     FUN_RANDOM_VEHICLE, FUN_RANDOM_REWARDS]
