...
class TOOLTIPS_CONSTANTS(object):
    ...
    ROYALE_LOBBY_SET = [BATTLE_ROYALE_VEHICLE, BATTLE_ROYALE_MODULES_HANGAR, BATTLE_ROYALE_BATTLE_PROGRESSION, 
     ...
     BATTLE_ROYALE_PERF_ADVANCED, BATTLE_ROYALE_SELECTOR_INFO, BATTLE_ROYALE_WIDGET_INFO, 
     BATTLE_ROYALE_COMPLETED_QUESTS_INFO, BATTLE_ROYALE_SELECTOR_CALENDAR_INFO, 
