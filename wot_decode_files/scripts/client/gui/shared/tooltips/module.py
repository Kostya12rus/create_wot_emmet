        ...
        if params:
            ...
            if module.itemTypeID == GUI_ITEM_TYPE.GUN:
                ...
                if reloadingType == GUN_CLIP or reloadingType == GUN_CAN_BE_CLIP:
                    ...
                    if reloadingType == GUN_CAN_BE_AUTO_RELOAD or reloadingType == GUN_AUTO_RELOAD:
    ...
    def _getStatus(self):
        ...
        if not isFit:
            ...
            if reason == 'not_with_installed_equipment':
                ...
                if reason in ('already_installed', 'similar_device_already_installed'):
