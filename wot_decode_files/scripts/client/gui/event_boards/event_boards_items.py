...
class EventsSettings(object):
    EXPECTED_FIELDS = [
     'battle_type', 'end_date', 'event_id', 'is_squad_allowed', 'leaderboard_view_size', 
     'limits', 
     'manual', 'method', 'name', 'objective_parameter', 
     'participants_freeze_deadline', 
     'prime_times', 'publish_date', 
     'rewarding_date', 'rewards_by_rank', 'start_date', 'type']
    ...
    EXPECTED_FIELDS_LIMITS = ['win_rate_min', 'win_rate_max', 'registration_date_max', 'is_registration_needed', 
     'battles_count_min', 
     'nations', 'vehicles', 'vehicles_levels', 'vehicles_classes']
...
class MyInfoInLeaderBoard(object):
    EXPECTED_FIELDS = [
     'rank', 'p1', 'p2', 'p3', 'page_number', 'is_inside_viewsize', 
     'last_in_leaderboard_value', 
     'battles_count', 'clan_tag', 
     'clan_color']
...
class LeaderBoard(object):
    ...
    EXPECTED_FIELDS_META = ['page_number', 'pages_amount', 'rewards', 'recalculation_interval', 
     ...
     'next_leaderboard_recalculation_ts']
    EXPECTED_FIELDS_DATA = ['spa_id', 'name', 'clan_tag', 'clan_color', 'rank', 'p1', 'p2', 'p3', 
     'info']
    ...
    CALCULATION_METHODS_EXPECTED_FIELDS = {CALCULATION_METHODS.MAX: [
                               'battle_ts', 
                               'vehicle_cd', 'battle_result', 
                               'is_in_squad', 'exp', 
                               'damage', 
                               'assisted_damage', 
                               'frags', 'blocked_damage'], 
