...
_INTERSECTED_ACTIONS_LIST = {
 ...
 'mul_GoodiePrice', 'mul_GoodiePriceAll', 
 'set_GoodiePrice', 
 'mul_EquipmentPrice', 'mul_EquipmentPriceAll', 'set_EquipmentPrice', 
 'mul_PrebattleInstructionsPrice', 
 'mul_PrebattleInstructionsPriceAll', 'mul_PrebattleInstructionsPricemul_HornPrice', 
 'mul_HornPriceAll', 
 'set_HornPrice', 
 'mul_OptionalDevicePrice', 'mul_OptionalDevicePriceAll', 
 'set_OptionalDevicePrice', 
 'cond_ShellGoldPrice', 'mul_ShellPrice', 'mul_ShellPriceAll', 
 'mul_ShellPriceNation', 
 'set_ShellPrice', 
 'cond_VehPrice', 'mul_VehPrice', 
 'mul_VehPriceAll', 'mul_VehPriceNation', 
 'set_VehPrice', 
 'cond_VehRentPrice', 
 'mul_VehRentPrice', 'mul_VehRentPriceAll', 
